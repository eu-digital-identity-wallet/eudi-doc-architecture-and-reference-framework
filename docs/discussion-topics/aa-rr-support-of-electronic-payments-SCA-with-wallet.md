...
To complement [TS12] an SCA Attestation Rulebook, at leas one, shall be made available. Such a rulebook is yet to be delivered.
...
### 5.3 Feedback from LSP and TS12 implementors 
...
According to the current PSR text ([PSR Provisional Agreement]), the Wallet Providers and SCA solution implementors (PSPs/banks and their providers) may need to take into account requirements related e.g. to mobile application activation, display and accessibility, liability and outsourcing aspects (wallet as an SCA means delivered by an external "technical service provider").
...
| [PaSO]   |  [Payments and SCA for OpenID](https://aptitude-consortium.github.io/payments-and-sca-for-openid/)  |
