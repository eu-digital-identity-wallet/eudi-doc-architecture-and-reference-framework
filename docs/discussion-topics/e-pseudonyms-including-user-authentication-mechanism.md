...
**Question 3:** For Use Case A: Should a single user be able to use their Wallet Unit to present several different pseudonyms to a single Relying Party?

**Question 4:** For both use cases: What assurances must be given to the Relying Party? Possible assurances exists on at least three levels:

1. No assurances are given to the Relying Party. I.e., the Relying Party is not even guaranteed that it is interacting with Wallet Unit.
