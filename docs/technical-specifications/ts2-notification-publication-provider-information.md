...
| Attribute   | Multiplicity | Type                        | Description                                                                                                                                                                      |
|-------------|--------------|-----------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `EEAIssuer` | [0..1]       | [*Provider*](#281-provider) | specifies the details of the *EEA issuer**, if it is not identical to the public sector body, which is responsible for the authentic source indicated in the ``Provider`` class. |
...
| Attribute             | Multiplicity | Type                                 | Description                                                                                                              |
|-----------------------|--------------|--------------------------------------|--------------------------------------------------------------------------------------------------------------------------|
| `trustSrv` | [1..*]      | [*TrustService*](#286-trustservice) | specifies the **details of the trust serivce**. |
...
(cf. [``WRPAccCertProvider``](#261-wrpacccertprovider)). 
...
The **TrustService** class is used within the definition of the [TrustServiceProvider](#26-trustserviceprovider) class. It contains the attributes specified in the following table:
