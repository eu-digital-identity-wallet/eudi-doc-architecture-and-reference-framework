...
This repository contains the "[Architecture and Reference Framework](./architecture-and-reference-framework-main.md)"
(hereinafter the [ARF](./architecture-and-reference-framework-main.md)).
