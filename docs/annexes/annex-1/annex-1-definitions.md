...
- In the first place, the [eIDAS 2.0] Regulation defines several of these terms. For
...
## A.2 Definitions from the [eIDAS 2.0] Regulation

The following terms are defined in the eIDAS 2.0 Regulation and used in the ARF.

| **Term** | **Definition in [eIDAS 2.0] Regulation** |
|-----------|-----------|
...
**Table 1: Definition of terms used in the ARF originating from the [eIDAS 2.0] Regulation**
...
| Wallet Unit | A unique configuration of a Wallet Solution that includes Wallet instances, Wallet Secure Cryptographic Applications and Wallet Secure Cryptographic Eevices provided by a Wallet Provider to an individual wallet User |
...
Note: The technical terms and definitions in Table 3 below are intended to be defined in such a way that they are aligned with the definitions used in the eIDAS 2.0 Regulation and the Commission Implementing Regulations in Tables 1 and 2, and should be interpreted as such. In case any definition in Table 3 contradicts a definition from the eIDAS 2.0 Regulation or the Commission Implementing Regulations, the latter take precedence.
