...
| QES_13 | Wallet Providers SHALL ensure that a Wallet Unit provides a log of transaction records of qualified electronic signatures generated by the Wallet Unit, allowing the User to view the history of previously signed data or documents. |
...
In this use case, the User is accessing a common dashboard of the
Wallet Unit, which provides a record of all transactions (i.e.
...
This Topic explores high-level requirements related to the functions
of such a common dashboard.  
